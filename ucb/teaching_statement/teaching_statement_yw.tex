...
\def\courseOneName{Introduction to Digital Electronics}
\def\courseOneNumber{EE 42}
\def\courseTwoName{Fundamental Algorithms for Systems Modeling, Analysis, and Optimization}
\def\courseTwoNumber{EE 144}
\def\courseThreeName{High Speed Communications Networks}
\def\courseThreeNumber{EE 228A}
\def\courseFourName{Computer Architecture and Engineering}
\def\courseFourNumber{EE 152}
