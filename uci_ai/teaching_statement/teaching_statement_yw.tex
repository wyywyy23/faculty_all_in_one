...
\def\courseOneNumber{COMPSCI 151}
\def\courseTwoName{Computer Systems Architecture}
\def\courseTwoNumber{COMPSCI 152}
\def\courseThreeName{Computer Aided Circuit Simulation and Verification }
\def\courseThreeNumber{ECE 245}
\def\courseFourName{Computer and Communication Networks}
\def\courseFourNumber{COMPSCI 232}
\def\courseFiveName{Modern Computer Systems}
\def\courseFiveNumber{COMPSCI 250B}
