...
\def\courseOneName{Electrical Circuits and Systems}
\def\courseOneNumber{ESE 2150}
\def\courseTwoName{Electronic Design Automation}
\def\courseTwoNumber{ESE 5350}
\def\courseThreeName{Integrated Photonic Systems}
\def\courseThreeNumber{ESE 6730}
\def\courseFourName{System-on-a-Chip Architecture}
\def\courseFourNumber{ESE 5320}
\def\courseFiveName{Datacenter Architecture}
\def\courseFiveNumber{ESE 6650}
