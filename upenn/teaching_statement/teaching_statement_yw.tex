...
\def\courseOneName{Computation Structures}
\def\courseOneNumber{\#6.1910}
\def\courseTwoName{Fundamentals of Photonics}
\def\courseTwoNumber{\#6.6330}
\def\courseThreeName{Control of Manufacturing Processes}
\def\courseThreeNumber{\#6.6630[J]}
\def\courseFourName{Computer System Architecture}
\def\courseFourNumber{\#6.5900}
