...
\def\courseTwoName{Fiber Optics}
\def\courseTwoNumber{EEE 448}
\def\courseThreeName{VLSI Design Automation}
\def\courseThreeNumber{EEE 598}
\def\courseFourName{Communication Networks}
\def\courseFourNumber{EEE 459}
\def\courseFiveName{Broadband Networks}
\def\courseFiveNumber{EEE 557}
