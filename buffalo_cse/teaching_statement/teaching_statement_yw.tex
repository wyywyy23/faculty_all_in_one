...
\def\courseOneNumber{CSE 241}
\def\courseTwoName{Hardware/Software Integrated Systems Design I}
\def\courseTwoNumber{CSE 450}
\def\courseThreeName{Introduction to VLSI Electronics}
\def\courseThreeNumber{CSE 593}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{CSE 490}
\def\courseFiveName{Introduction to Parallel and Distributed Processing}
\def\courseFiveNumber{CSE 570}
