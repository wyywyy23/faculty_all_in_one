...
\def\courseOneName{Introduction to Waves and Photonics}
\def\courseOneNumber{ELEC 262}
\def\courseTwoName{Digital Logic Design}
\def\courseTwoNumber{ELEC 326/COMP 326}
\def\courseThreeName{Computer Systems Architecture}
\def\courseThreeNumber{ELEC 425/COMP 425}
\def\courseFourName{Introduction to Computer Networks}
\def\courseFourNumber{ELEC 429/COMP 429}
\def\courseFiveName{Distributed Systems}
\def\courseFiveNumber{ELEC 520/COMP 520}
