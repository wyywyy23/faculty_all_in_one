...
\def\courseOneName{Electrics Circuits}
\def\courseOneNumber{ECSE 2010}
\def\courseTwoName{Digital Electronics}
\def\courseTwoNumber{ECSE 4040}
\def\courseThreeName{Optoelectronics Technology}
\def\courseThreeNumber{ECSE 4370}
\def\courseFourName{Advanced Computer Systems}
\def\courseFourNumber{ECSE 4320}
\def\courseFiveName{Computer Hardware Design}
\def\courseFiveNumber{ECSE 4770}
