...
\def\courseOneNumber{EECS 31}
\def\courseTwoName{VLSI}
\def\courseTwoNumber{EECS 119}
\def\courseThreeName{Optical Communications}
\def\courseThreeNumber{EECS 285A}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{EECS 213}
\def\courseFiveName{Computer and Communication Networks}
\def\courseFiveNumber{EECS 248A}
