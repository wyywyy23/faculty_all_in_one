...
\def\courseOneNumber{COS306}
\def\courseTwoName{Design of Very Large Scale Integrated (VLSI) Systems}
\def\courseTwoNumber{COS462}
...
\def\courseFourNumber{COS375}
\def\courseFiveName{Computer Networks}
\def\courseFiveNumber{COS461}
