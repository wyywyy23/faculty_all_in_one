...
\def\courseOneNumber{ECE3700}
\def\courseTwoName{Optical Communication Systems}
\def\courseTwoNumber{ECE5411}
\def\courseThreeName{Computer-Aided Design of Digital Circuits}
\def\courseThreeNumber{ECE5740}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{ECE6810}
\def\courseFiveName{Embedded System Design}
\def\courseFiveNumber{ECE6780}
