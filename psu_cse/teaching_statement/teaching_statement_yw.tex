...
\def\courseOneName{Digital Design: Theory and Practice}
\def\courseOneNumber{CMPEN 270}
\def\courseTwoName{Computer Organization And Design}
\def\courseTwoNumber{CMPEN 331}
\def\courseThreeName{Fundamentals of Computer Architecture}
\def\courseThreeNumber{CSE 530}
\def\courseFourName{Communication Networks}
\def\courseFourNumber{CMPEN 362}
\def\courseFiveName{Parallel Processors and Processing}
\def\courseFiveNumber{CSE 531}
