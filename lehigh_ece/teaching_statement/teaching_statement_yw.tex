...
\def\courseOneNumber{ECE 319}
\def\courseTwoName{Introduction to Integrated Optics}
\def\courseTwoNumber{ECE 347}
\def\courseThreeName{Optical Networks}
\def\courseThreeNumber{ECE 372}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{ECE 201}
\def\courseFiveName{Accelerated Computing for Deep Learning}
\def\courseFiveNumber{ECE 303}
