...
\def\courseOneName{Computer System Fundamentals}
\def\courseOneNumber{EN.601.229}
\def\courseTwoName{Computer Networks}
\def\courseTwoNumber{EN.601.414}
\def\courseThreeName{Introduction To VLSI}
\def\courseThreeNumber{EN.520.216}
\def\courseFourName{Parallel Computing for Data Science}
\def\courseFourNumber{EN.601.420}
\def\courseFiveName{Federated Learning and Analytics}
\def\courseFiveNumber{EN.601.637}
