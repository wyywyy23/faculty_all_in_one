...
\def\courseTwoName{Datacenter Systems}
\def\courseTwoNumber{CSE 453}
\def\courseThreeName{Very Large Scale Integration}
\def\courseThreeNumber{CSE 468}
\def\courseFourName{Computer Architecture I}
\def\courseFourNumber{CSE 469}
\def\courseFiveName{Introduction to Embedded Systems}
\def\courseFiveNumber{CSE 474}
