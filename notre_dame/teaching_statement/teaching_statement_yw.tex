...
\def\courseOneName{Logic Design and Sequential Circuits}
\def\courseOneNumber{CSE 20221}
\def\courseTwoName{Computer Architecture}
\def\courseTwoNumber{CSE 30321}
\def\courseThreeName{Cross-Layer Design for CMOS and Beyond-CMOS Technologies}
\def\courseThreeNumber{CSE 40947}
\def\courseFourName{Embedded System Development}
\def\courseFourNumber{CSE 40373}
\def\courseFiveName{Hardware Platforms for Deep Learning and Optimization}
\def\courseFiveNumber{CSE 40445}
