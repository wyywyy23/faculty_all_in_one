...
\def\courseOneName{Structure and Design of Digital Systems}
\def\courseOneNumber{\#18-240}
\def\courseTwoName{Digital Integrated Circuit Design}
\def\courseTwoNumber{\#18-422}
\def\courseThreeName{Elements of Photonics for Communication Systems}
\def\courseThreeNumber{\#18-712}
\def\courseFourName{Hardware Arithmetic for Machine Learning}
\def\courseFourNumber{\#18-340}
\def\courseFiveName{Introduction to Computer Architecture}
\def\courseFiveNumber{\#18-447}
\def\courseSixName{Electronic Photonic Design Automation}
\def\courseSevenName{Silicon Photnoics Optical Interconnects}
