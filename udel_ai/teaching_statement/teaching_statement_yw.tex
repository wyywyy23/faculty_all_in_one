...
\def\courseOneNumber{CPEG 202}
\def\courseTwoName{Introduction to VLSI Systems}
\def\courseTwoNumber{CPEG 460}
\def\courseThreeName{Integrated Optics}
\def\courseThreeNumber{ELEG 853}
\def\courseFourName{Opto-electronics}
\def\courseFourNumber{ELEG 440}
\def\courseFiveName{Embedded Systems Hardware/Software Co-Design}
\def\courseFiveNumber{CPEG 622}
