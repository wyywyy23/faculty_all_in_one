...
\def\courseOneNumber{CSE 120}
\def\courseTwoName{VLSI Design Automation}
\def\courseTwoNumber{CEN 598/EEE 598}
\def\courseThreeName{Semiconductor Device Theory}
\def\courseThreeNumber{EEE 531}
\def\courseFourName{Computer Architecture I}
\def\courseFourNumber{CSE 420}
\def\courseFiveName{Advanced Computer Networks}
\def\courseFiveNumber{CSE 534}
