...
\def\courseOneName{Computer Organization and Architecture}
\def\courseOneNumber{CSE 202}
\def\courseTwoName{Embedded Systems}
\def\courseTwoNumber{CSE 336}
\def\courseThreeName{Optical Networks}
\def\courseThreeNumber{ECE 372}
\def\courseFourName{Computer Networks}
\def\courseFourNumber{CSE 404}
\def\courseFiveName{Accelerated Computing for Machine Learning}
\def\courseFiveNumber{DSCI 421}
