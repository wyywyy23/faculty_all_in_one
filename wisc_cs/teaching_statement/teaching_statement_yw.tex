...
\def\courseOneNumber{​COMP SCI/ECE 352}
\def\courseTwoName{Introduction to Computer Architecture}
\def\courseTwoNumber{​COMP SCI/ECE 552}
\def\courseThreeName{Computer-Aided Design for VLSI}
\def\courseThreeNumber{C​COMP SCI/ECE 756}
\def\courseFourName{Introduction to Big Data Systems}
\def\courseFourNumber{COMP SCI 544}
