...
\def\courseOneName{Digital Logic and Computer Organization}
\def\courseOneNumber{ECE 2300}
\def\courseTwoName{Embedded Systems}
\def\courseTwoNumber{ECE 3140}
\def\courseThreeName{Photonics: Fundamentals and Devices}
\def\courseThreeNumber{ECE 5340}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{ECE 4750}
\def\courseFiveName{Datacenter Computing}
\def\courseFiveNumber{ECE 5710}
