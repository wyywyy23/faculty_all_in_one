...
\def\courseOneName{Electrical Circuits}
\def\courseOneNumber{ECE 2001}
\def\courseTwoName{Digital Integrated Circuits}
\def\courseTwoNumber{ECE 3221}
\def\courseThreeName{Optoelectronic Devices}
\def\courseThreeNumber{ECE 5232}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{ECE 5402}
\def\courseFiveName{VLSI CAD Algorithms}
\def\courseFiveNumber{ECE 6422}
