...
\def\courseOneName{Fundamentals of Logic Design}
\def\courseOneNumber{ECE 212}
\def\courseTwoName{Introduction to Photonics and Optical Communications}
\def\courseTwoNumber{ECE 423}
\def\courseThreeName{Design Of Electronic Packaging and Interconnects}
\def\courseThreeNumber{ECE 544}
\def\courseFourName{Architecture Of Parallel Computers}
\def\courseFourNumber{ECE 406}
\def\courseFiveName{VLSI Systems Design}
\def\courseFiveNumber{ECE 546}
