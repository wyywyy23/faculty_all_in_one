...
\def\courseOneName{Digital System Design I/II}
\def\courseOneNumber{CMPE-160/260}
\def\courseTwoName{Reconfigurable Computing}
\def\courseTwoNumber{CMPE-660}
\def\courseThreeName{Photonic Integrated Circuits}
\def\courseThreeNumber{EEEE-715}
\def\courseFourName{Computer Architecture}
\def\courseFourNumber{CMPE-550}
\def\courseFiveName{Data and Communication Networks}
\def\courseFiveNumber{CMPE-670}
