...
PSU_CSE_RS_DEP = $(RS_COMMON_SRC) psu_cse/common.tex

PSU_CSE_TS_SRC = psu_cse/teaching_statement/teaching_statement_yw.tex
PSU_CSE_TS_PDF = $(PSU_CSE_TS_SRC:.tex=.pdf)
PSU_CSE_TS_DEP = $(TS_COMMON_SRC) psu_cse/common.tex

PSU_CSE_DS_SRC = psu_cse/diversity_statement/diversity_statement_yw.tex
...
JHU_CS_RS_DEP = $(RS_COMMON_SRC) jhu_cs/common.tex

JHU_CS_TS_SRC = jhu_cs/teaching_statement/teaching_statement_yw.tex
JHU_CS_TS_PDF = $(JHU_CS_TS_SRC:.tex=.pdf)
JHU_CS_TS_DEP = $(TS_COMMON_SRC) jhu_cs/common.tex

JHU_CS_DS_SRC = jhu_cs/diversity_statement/diversity_statement_yw.tex
...
BUFFALO_CSE_LETTER_SRC = buffalo_cse/cover_letter/cover_letter_yw.tex
BUFFALO_CSE_LETTER_PDF = $(BUFFALO_CSE_LETTER_SRC:.tex=.pdf)
BUFFALO_CSE_LETTER_DEP = $(filter-out $(wildcard common/letterhead/attachment/*) $(wildcard common/letterhead/signature/*), $(LH_DEP)) $(SIG_PDF) $(LETTER_COMMON_SRC) buffalo_cse/common.tex

BUFFALO_CSE_RS_SRC = buffalo_cse/research_statement/research_statement_yw.tex
BUFFALO_CSE_RS_PDF = $(BUFFALO_CSE_RS_SRC:.tex=.pdf)
BUFFALO_CSE_RS_DEP = $(RS_COMMON_SRC) buffalo_cse/common.tex

BUFFALO_CSE_TS_SRC = buffalo_cse/teaching_statement/teaching_statement_yw.tex
BUFFALO_CSE_TS_PDF = $(BUFFALO_CSE_TS_SRC:.tex=.pdf)
BUFFALO_CSE_TS_DEP = $(TS_COMMON_SRC) buffalo_cse/common.tex

BUFFALO_CSE_DS_SRC = buffalo_cse/diversity_statement/diversity_statement_yw.tex
...
jhu-cs: jhu-cs-letter jhu-cs-rs jhu-cs-ts jhu-cs-ds
jhu-cs-letter: $(JHU_CS_LETTER_PDF)
...
buffalo-cse: buffalo-cse-letter buffalo-cse-rs buffalo-cse-ts buffalo-cse-ds
buffalo-cse-letter: $(BUFFALO_CSE_LETTER_PDF)
...
$(PSU_CSE_LETTER_PDF): $(PSU_CSE_LETTER_SRC) $(PSU_CSE_LETTER_DEP) | clean-cache $(CACHE_DIR)
	...
	@cd $(dir $(PSU_CSE_LETTER_SRC)) && $(COMPILE_LUA) $(notdir $(PSU_CSE_LETTER_SRC))
	@cp $(CACHE_DIR)/$(notdir $(PSU_CSE_LETTER_PDF)) $(PSU_CSE_LETTER_PDF)

$(PSU_CSE_RS_PDF): $(PSU_CSE_RS_SRC) $(PSU_CSE_RS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(PSU_CSE_RS_SRC)) && $(COMPILE_LUA) $(notdir $(PSU_CSE_RS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(PSU_CSE_RS_PDF)) $(PSU_CSE_RS_PDF)

$(PSU_CSE_TS_PDF): $(PSU_CSE_TS_SRC) $(PSU_CSE_TS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(PSU_CSE_TS_SRC)) && $(COMPILE_LUA) $(notdir $(PSU_CSE_TS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(PSU_CSE_TS_PDF)) $(PSU_CSE_TS_PDF)
...
$(JHU_CS_LETTER_PDF): $(JHU_CS_LETTER_SRC) $(JHU_CS_LETTER_DEP) | clean-cache $(CACHE_DIR)
	@cp -r $(LH_FONT_DIR) $(dir $(JHU_CS_LETTER_SRC))/.
	@cd $(dir $(JHU_CS_LETTER_SRC)) && $(COMPILE_LUA) $(notdir $(JHU_CS_LETTER_SRC))
	@cp $(CACHE_DIR)/$(notdir $(JHU_CS_LETTER_PDF)) $(JHU_CS_LETTER_PDF)

$(JHU_CS_RS_PDF): $(JHU_CS_RS_SRC) $(JHU_CS_RS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(JHU_CS_RS_SRC)) && $(COMPILE_LUA) $(notdir $(JHU_CS_RS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(JHU_CS_RS_PDF)) $(JHU_CS_RS_PDF)

$(JHU_CS_TS_PDF): $(JHU_CS_TS_SRC) $(JHU_CS_TS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(JHU_CS_TS_SRC)) && $(COMPILE_LUA) $(notdir $(JHU_CS_TS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(JHU_CS_TS_PDF)) $(JHU_CS_TS_PDF)
...
$(BUFFALO_CSE_LETTER_PDF): $(BUFFALO_CSE_LETTER_SRC) $(BUFFALO_CSE_LETTER_DEP) | clean-cache $(CACHE_DIR)
	@cp -r $(LH_FONT_DIR) $(dir $(BUFFALO_CSE_LETTER_SRC))/.
	@cd $(dir $(BUFFALO_CSE_LETTER_SRC)) && $(COMPILE_LUA) $(notdir $(BUFFALO_CSE_LETTER_SRC))
	@cp $(CACHE_DIR)/$(notdir $(BUFFALO_CSE_LETTER_PDF)) $(BUFFALO_CSE_LETTER_PDF)

$(BUFFALO_CSE_RS_PDF): $(BUFFALO_CSE_RS_SRC) $(BUFFALO_CSE_RS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(BUFFALO_CSE_RS_SRC)) && $(COMPILE_LUA) $(notdir $(BUFFALO_CSE_RS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(BUFFALO_CSE_RS_PDF)) $(BUFFALO_CSE_RS_PDF)

$(BUFFALO_CSE_TS_PDF): $(BUFFALO_CSE_TS_SRC) $(BUFFALO_CSE_TS_DEP) | clean-cache $(CACHE_DIR)
	@cd $(dir $(BUFFALO_CSE_TS_SRC)) && $(COMPILE_LUA) $(notdir $(BUFFALO_CSE_TS_SRC))
	@cp $(CACHE_DIR)/$(notdir $(BUFFALO_CSE_TS_PDF)) $(BUFFALO_CSE_TS_PDF)
